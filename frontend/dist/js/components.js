                                ...
                                <div class="editor-toolbar">
                                    ...
                                    <div class="toolbar-group">
                                        <select class="toolbar-select font-name-select" title="Phông chữ">
                                         ...
                                         <div class="font-size-combobox" style="position: relative; display: inline-flex; align-items: center; background-color: #ffffff; border: 1px solid var(--border-color); border-radius: 4px; height: 30px;">
                                             <input type="text" class="font-size-input" value="14px" title="Cỡ chữ" style="width: 42px; text-align: center; border: none; height: 28px; font-size: 12px; padding: 0 2px; outline: none; background: transparent; color: var(--text-primary);">
                                             <button class="combobox-arrow-btn" type="button" style="height: 28px; width: 18px; background: transparent; border: none; border-left: 1px solid var(--border-color); display: flex; align-items: center; justify-content: center; cursor: pointer; color: var(--text-secondary); padding: 0;" title="Danh sách cỡ chữ">
                                                 <i data-lucide="chevron-down" style="width: 10px; height: 10px;"></i>
                                             </button>
                                             <div class="combobox-dropdown" style="position: absolute; top: 100%; left: 0; right: 0; background-color: #ffffff; border: 1px solid var(--border-color); border-radius: 4px; box-shadow: var(--shadow-md); z-index: 1000; max-height: 180px; overflow-y: auto; display: none; margin-top: 2px; min-width: 62px;">
                                                 <div class="combobox-item" data-value="12px" style="padding: 6px 10px; font-size: 12px; cursor: pointer; transition: all 0.2s;">12px</div>
                                                 <div class="combobox-item" data-value="14px" style="padding: 6px 10px; font-size: 12px; cursor: pointer; transition: all 0.2s;">14px</div>
                                                 <div class="combobox-item" data-value="16px" style="padding: 6px 10px; font-size: 12px; cursor: pointer; transition: all 0.2s;">16px</div>
                                                 <div class="combobox-item" data-value="18px" style="padding: 6px 10px; font-size: 12px; cursor: pointer; transition: all 0.2s;">18px</div>
                                                 <div class="combobox-item" data-value="24px" style="padding: 6px 10px; font-size: 12px; cursor: pointer; transition: all 0.2s;">24px</div>
                                             </div>
                                         </div>
                                         <!--
                                         ...
                                         <div style="display: none;"><select class="toolbar-select font-size-select" title="Cỡ chữ">
